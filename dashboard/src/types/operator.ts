...
export const OPERADORES_PREDETERMINADOS: Operator[] = [
  ...
  {
    codigo: '02',
    nombre: 'Nancy Delgadillo',
    rol: 'Operadora',
    clave: 'NancyGama2026*',
    atributos: DEFAULT_ATTRIBUTES_BY_ROLE.Operadora,
  },
  {
    codigo: '03',
    nombre: 'Ximena Cortez',
    rol: 'Operadora',
    clave: 'XimenaGama2026*',
    atributos: DEFAULT_ATTRIBUTES_BY_ROLE.Operadora,
  },
  {
    codigo: '04',
    nombre: 'Andres Alzamora',
    rol: 'Operador',
    clave: 'AndresGama2026*',
    atributos: DEFAULT_ATTRIBUTES_BY_ROLE.Operador,
  },
  {
    codigo: '05',
    nombre: 'Angelina Toro',
    rol: 'Operadora',
    clave: 'AngelinaGama2026*',
    atributos: DEFAULT_ATTRIBUTES_BY_ROLE.Operadora,
  },
  {
    codigo: '06',
    nombre: 'Tamara Zamora',
    rol: 'Operadora',
    clave: 'TamaraGama2026*',
    atributos: DEFAULT_ATTRIBUTES_BY_ROLE.Operadora,
  },
]
