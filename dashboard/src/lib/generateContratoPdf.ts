...
Quienes han convenido suscribir el presente Contrato de Prestación de Servicios de Monitoreo, el cual se regirá por las siguientes cláusulas:`
  ...
  const clausulas = [
    ...
    {
      titulo: 'NOVENO: PROTECCIÓN DE DATOS PERSONALES, PRIVACIDAD Y SEGURIDAD (LEY N° 21.719)',
      cuerpo: `Conforme a la Ley N° 21.719 que regula la Protección y el Tratamiento de los Datos Personales y crea la Agencia de Protección de Datos Personales (APDP), las partes estipulan:\n1. Base de Licitud: El tratamiento de los datos personales y de seguridad del Cliente (RUT, teléfonos, nombres de contactos, horarios y coordenadas de la propiedad) se fundamenta en la ejecución del presente contrato de servicios de monitoreo y seguridad patrimonial (Art. 13 letra b).\n2. Deber de Secreto y Seguridad: GAMA implementa medidas técnicas de cifrado, control de privilegios mínimos y trazabilidad forense de accesos de operadores. Las contraclaves y claves maestras son de carácter reservado y solo se consultan para verificar emergencias activas.\n3. Derechos ARCO+: El Cliente o titular podrá ejercer en todo momento sus derechos de Acceso, Rectificación, Supresión, Oposición, Portabilidad y Bloqueo mediante solicitud escrita dirigida a: privacidad@gamasecurity.cl, la que será respondida en el plazo legal de 15 días hábiles.\n4. Autorización de Notificaciones: El Cliente autoriza expresamente el envío de alertas y notificaciones de eventos de alarma a través de llamadas automáticas, SMS, correos y mensajería instantánea (WhatsApp) a los contactos declarados. Es responsabilidad exclusiva del Cliente mantener actualizada su nómina de contactos escribiendo a: ${serv.email_actualizacion_contactos || 'ecarrasco@gamasecurity.cl'}.`
    },
    {
