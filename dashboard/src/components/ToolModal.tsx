...
export default function ToolModal({ modalId, onClose }: ToolModalProps) {
  ...
  const contactIdCodes = [
    ...
    { code: '120', name: 'ALARMA DE PÁNICO', desc: 'Botón de pánico presionado por usuario' },
    { code: '130', name: 'ALARMA DE ROBO', desc: 'Intrusión detectada en zona perimetral/interior' },
    { code: '137', name: 'TAMPER / SABOTAJE', desc: 'Sabotaje de caja de panel o sirena detectado' },
    ...
    { code: '401', name: 'APERTURA POR USUARIO', desc: 'Sistema desarmado por código de usuario' },
    { code: '402', name: 'CIERRE POR USUARIO', desc: 'Sistema armado por código de usuario' },
    { code: '602', name: 'AUTOTEST PERIÓDICO', desc: 'Señal de prueba automática diaria del panel' },
  ]
