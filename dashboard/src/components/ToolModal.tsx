...
export default function ToolModal({ modalId, onClose, operadores = [], onUpdateOperadores }: ToolModalProps) {
  ...
  const contactIdFullCodes = [
    ...
    { code: '530', cat: 'TÉCNICA', eCode: 'E530', eName: 'FALLA COBERTURA ELEM. INALAM.', eDesc: 'Pérdida de señal o cobertura en elemento/sensor inalámbrico', rCode: 'R530', rName: 'REST. COBERTURA ELEM. INALAM.', rDesc: 'Cobertura y enlace de elemento inalámbrico normalizado' },
