...
export default function AreaClientesPortal() {
  ...
  return (
    <div className="min-h-screen bg-[#060a12] text-slate-100 flex flex-col font-sans selection:bg-[#2997ff]/30 selection:text-white overflow-x-hidden pb-20 lg:pb-0">
      ...
      {/* ════════════════════════════════════════════════════════════════════
         BARRA SUPERIOR MOBILE (< lg) CON OCTÁGONO Y HAMBURGUESA
         ════════════════════════════════════════════════════════════════════ */}
      <header className="lg:hidden sticky top-0 z-40 bg-[#08101d]/95 backdrop-blur-xl border-b border-[#1a2e4a]/80 px-4 py-3 flex items-center justify-between shadow-xl">
        <div className="flex items-center gap-3">
          <button
            onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
            className="p-2 rounded-xl bg-[#0e1a2e] border border-[#1e3a5f] text-slate-200 hover:text-white transition"
            aria-label="Abrir menú"
          >
            {mobileMenuOpen ? <X className="w-5 h-5 text-amber-400" /> : <Menu className="w-5 h-5 text-[#2997ff]" />}
          </button>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-red-600/90 text-white font-bold text-[11px] uppercase tracking-wider flex items-center gap-1.5 shadow-md shadow-red-900/40"
        >
      ...
      <div className="flex flex-1 min-h-screen relative">
        ...
        {/* ════════════════════════════════════════════════════════════════════
           SIDEBAR LATERAL (RESPONSIVE: DRAWER EN MOBILE, AUTOFLEX EN DESKTOP)
           ════════════════════════════════════════════════════════════════════ */}
        ...
        <aside
          className={`fixed lg:static top-0 bottom-0 left-0 z-50 lg:z-30 w-72 bg-[#08101d]/98 lg:bg-[#08101d]/90 backdrop-blur-2xl border-r border-[#1a2e4a]/80 transition-transform duration-300 ease-in-out flex flex-col justify-between ${
        ...
        >
          <div className="p-5 flex flex-col items-center overflow-y-auto">
            ...
            <div className="relative group cursor-pointer my-3 flex flex-col items-center w-full">
              ...
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 bg-[#0a1628] border border-[#2a4875] rounded-3xl p-4 flex items-center justify-center shadow-2xl shadow-[#0066cc]/30 transition-transform duration-300 group-hover:scale-105">
              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3.5 px-4 py-3 rounded-xl font-semibold text-xs sm:text-sm transition-all duration-200 group relative ${
                      isActive
                  ...
                  >
                    ...
                    {item.badge && (
                      <span className="text-[9px] sm:text-[10px] bg-[#2997ff]/20 text-[#2997ff] border border-[#2997ff]/30 px-2 py-0.5 rounded-full font-mono font-semibold">
                        {item.badge}
                      </span>
                    )}
                  </button>
          ...
          <div className="p-4 m-3 bg-[#0a1628]/90 border border-[#1e3a5f]/60 rounded-2xl flex items-center justify-between">
        ...
        {/* ════════════════════════════════════════════════════════════════════
           CONTENIDO PRINCIPAL ADAPTABLE (MOBILE, TABLET, DESKTOP, 4K)
           ════════════════════════════════════════════════════════════════════ */}
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-7xl mx-auto w-full">
          ...
          {/* ════════════════════════════════════════════════════════════════════
             PESTAÑA 2: CÁMARAS EN VIVO (GRID RESPONSIVE 4K / HD)
             ════════════════════════════════════════════════════════════════════ */}
          {activeTab === 'camaras' && (
                ...
                {[
                  ...
                  <div key={cam.id} className="bg-[#091526] border border-[#1a3356]/60 rounded-2xl overflow-hidden group shadow-xl">
                    <div className="relative aspect-video bg-slate-950 flex items-center justify-center overflow-hidden">
                      {/* Simulación visual de streaming */}
      ...
      {/* ════════════════════════════════════════════════════════════════════
         ...
         ════════════════════════════════════════════════════════════════════ */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#08101d]/95 backdrop-blur-xl border-t border-[#1a2e4a]/80 px-2 py-2 flex items-center justify-around">
        {[
