  ...
  return (
    <div className="whatsapp-floating fixed bottom-6 right-6 z-50 flex items-center group">
      ...
      <button
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.6)] transition-all duration-300 transform group-hover:scale-110 active:scale-95"
      ...
      <style>{`
        .whatsapp-floating {
          animation: fadeInScale 0.4s ease-out 1s forwards;
          opacity: 0;
          transform: scale(0);
        }
