...
export default function Contacto() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSending(false)
      setSent(true)
      // Open mail client to send to contacto@gamasecurity.cl
  ...
  const CONTACTOS = [
    {
      ...
      label: 'Teléfono / WhatsApp 24/7',
      value: '+56 9 9101 6912',
    ...
    },
    {
      ...
      value: 'contacto@gamasecurity.cl',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="text-xs font-semibold text-[#0066cc] uppercase tracking-widest font-sans">
            CONTACTO Y COTIZACIÓN DE SEGURIDAD
          </span>
          ...
          <p className="apple-lead text-[#7a7a7a] text-base sm:text-lg max-w-xl mx-auto">
            Cotización clara y transparente sin compromiso. Escríbenos a contacto@gamasecurity.cl.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <div className={`inline-flex items-center gap-2.5 px-4 py-2 rounded-full border text-xs font-semibold ${
              ...
              Central {abierta ? 'activa y atendiendo' : 'en monitoreo 24/7'} · Lun-Vie 09:00 - 18:00
            </div>
              ...
              {sent ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <p className="text-[#7a7a7a] text-sm max-w-sm mx-auto">
                    Se abrirá tu cliente de correo para enviar directamente a <strong>contacto@gamasecurity.cl</strong>. También puedes escribirnos por WhatsApp al <strong>+56 9 9101 6912</strong>.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="alarmas">Alarmas DSC Power Series</option>
                  ...
                  <p className="text-center text-xs text-[#7a7a7a] pt-2">
                    Enviará correo directo a contacto@gamasecurity.cl · Sin compromisos comerciales
                  </p>
                </form>
              )}
            </div>
