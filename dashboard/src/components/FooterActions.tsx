...
export default function FooterActions({
  ...
  return (
    <>
      {/* 
        PIE DE PÁGINA RETRO INTEGRADO SCORPION WINDOWS 95:
        - h-12 fija (shrink-0) sin overflow ni scrollbars externas
        - Izquierda: Estado del Operador activo (estilo bisel hundido Windows)
        - Centro: Botonera de herramientas retro 16-bits
        - Derecha: Reloj digital e información de fecha/hora en vivo
      */}
      <footer className="h-12 shrink-0 bg-[#d4d0c8] border-t-2 border-white px-3 flex items-center justify-between select-none z-30 relative w-full shadow-md">
          ...
          {BOTONES_RETRO.map((btn) => (
            ...
            >
              ...
              {btn.id === 'notificaciones-whatsapp' && unreadWhatsAppCount && unreadWhatsAppCount > 0 ? (
                <div className="absolute -top-1.5 -right-1.5 bg-red-600 text-white font-bold text-[9px] min-w-[18px] h-[18px] px-1 rounded-full flex items-center justify-center border-2 border-white shadow-lg animate-bounce z-20 font-mono">
        ...
        {/* VERSIÓN MÓVIL: Botón Menú Scorpion */}
